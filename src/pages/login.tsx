        ...
        <div className="min-h-[600px] w-full flex" >
            ...
            <form className="min-h-[600px] bg-white w-full h-full z-40 border-l-2 md:w-1/2" >
                ...
                <div className="p-5 m-auto relative ">
                    ...
                    <button onClick={e => handleRegister(e)} className="ml-5 transition bg-gradient-to-r from-purple-500 to-pink-500 text-white w-full rounded-lg h-16 hover:from-violet-500 hover:to-fuchsia-500" type="submit">Register now!</button>
                    </div>
